...
```bash
python train_DiSOL_Thermal_Conduction.py --pt_path ./data/Training_Thermal_Conduction.pt --save_dir ./model_ckpt --epochs 500 --batch_size 200 --lr 1e-4 --weight_decay 1e-5 --save_every 10 --save_best
```
